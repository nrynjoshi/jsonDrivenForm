    ...
    <div class="col-lg-10">
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <form method="POST" action="/admin/jsfunction">
                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${functionList}" var="function">
                        <tr>
                            ...
                            <td>${function.url}</td>
                            <td>
                                <a href="/admin/jsfunction/edit/${function._id}" class="btn btn-primary">Edit</a>
                                <a href="/admin/jsfunction/${function._id}" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
